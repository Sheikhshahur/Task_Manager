...
<!--                               <th>Edit</th>-->
        ...
        <tbody>
                                 <?php
                 $qry = mysqli_query($connection, "SELECT * FROM assign_task where status='Cancel' order by work_assign_date desc") or die("select query fail" . mysqli_error());
$count = 0;

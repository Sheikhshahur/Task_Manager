...
//   $aadhare_img_front= $Date2.$ranNM2 . $Extension;  
    ...
    $file = $_FILES['aadhare_img_front']['tmp_name']; 
      if(!empty($file)) {
        ...
        $sourceProperties = getimagesize($file);
        $fileNewName = time();
        $folderPath = "aadhare_img/";
        $ext = pathinfo($_FILES['aadhare_img_front']['name'], PATHINFO_EXTENSION);
        $imageType = $sourceProperties[2];
        $aadhare_img_front='';
        ...
        switch ($imageType) {
            ...
            //    imagepng($targetLayer,$folderPath. $fileNewName. "_thump.". $ext);
                 imagepng($targetLayer,$folderPath. $fileNewName.".".$ext);
                 $aadhare_img_front=$fileNewName.".".$ext;
                break;
...
//   //aadhare img front
   ...
   $file = $_FILES['aadhare_img_back']['tmp_name']; 
      if(!empty($file)) {
        ...
        $fileNewName = time();
        $folderPath = "aadhare_img/";
        $ext = pathinfo($_FILES['aadhare_img_back']['name'], PATHINFO_EXTENSION);
        $imageType = $sourceProperties[2];
        $aadhare_img_back='';
        ...
        switch ($imageType) {
            ...
            //    imagepng($targetLayer,$folderPath. $fileNewName. "_thump.". $ext);
                 imagepng($targetLayer,$folderPath. $fileNewName.".".$ext);
                 $aadhare_img_back=$fileNewName.".".$ext;
                break;
...
//   $Pancard_img_front= $Date2.$ranNM4 . $Extension;        
        //pan card
          $file = $_FILES['Pancard_img_front']['tmp_name']; 
      if(!empty($file)) {
        ...
        $fileNewName = time();
        $folderPath = "pan_img/";
        $ext = pathinfo($_FILES['Pancard_img_front']['name'], PATHINFO_EXTENSION);
        $imageType = $sourceProperties[2];
        $Pancard_img_front='';
        ...
        switch ($imageType) {
            ...
            //    imagepng($targetLayer,$folderPath. $fileNewName. "_thump.". $ext);
                 imagepng($targetLayer,$folderPath. $fileNewName.".".$ext);
                 $Pancard_img_front=$fileNewName.".".$ext;
                break;
...
//   $Pancard_img_back= $Date2.$ranNM5. $Extension;    
        //pan card back
  $file = $_FILES['Pancard_img_back']['tmp_name']; 
      if(!empty($file)) {
        ...
        $fileNewName = time();
        $folderPath = "pan_img/";
        $ext = pathinfo($_FILES['Pancard_img_back']['name'], PATHINFO_EXTENSION);
        $imageType = $sourceProperties[2];
        $Pancard_img_back='';
        ...
        switch ($imageType) {
            ...
            //    imagepng($targetLayer,$folderPath. $fileNewName. "_thump.". $ext);
                 imagepng($targetLayer,$folderPath. $fileNewName.".".$ext);
                 $Pancard_img_back=$fileNewName.".".$ext;
                break;

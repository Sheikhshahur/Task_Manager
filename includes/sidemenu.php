                    ...
                    ?>
                            ...
                            <div class="sub-menu-w">
                                ...
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="assign_task_open_list.php">Open Task</a></li>  
                                        <li><a href="assign_task_list_close.php">Close Task</a></li>  
                                        <li><a href="assign_task_list_ongoing.php">WIP(Work In Process) Task</a></li>  
                                        <li><a href="assign_task_list_cancel.php">Cancel Task</a></li>  
                                    </ul>
                                </div>
                            </div>
                        ...
                        <!-- <li class=" has-sub-menu">
                            ...
                            <div class="sub-menu-w">
                                ...
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        <li><a href="Inward.php">Inward report</a></li>
                                        <li><a href="Outward.php">Outward Report</a></li>  
                            ...
                            <div class="sub-menu-w">
                                ...
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                            <li><a href="add_assets.php"> </a></li>
                                         <li><a href="assets_list.php"> </a></li>
                                           <li><a href="emp_assign_assets.php">  </a></li>  
                                            <li><a href="emp_assign_assets_list.php">   </a></li>  
                                            <li><a href="emp_assign_assets.php">  </a></li>  
                            ...
                            <div class="sub-menu-w">
                                ...
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        <li><a href="Inward.php">Inward Report</a></li>
                                        <ul class="sub-menu">
                                            <li><a href="Inward-1.php">Inward Report-2</a></li>
                                        </ul>
                                        <li><a href="Outward.php">Outward Report</a></li>  
                                        <ul class="sub-menu">
                                            <li><a href="outward-1.php">Outward Report-2</a></li>
                                        </ul>  
                                        <li><a href="worksheet.php">Worksheet</a></li> 
                                        <ul class="sub-menu">
                                            <li><a href="worksheet-1.php">worksheet-2</a></li>
                                        </ul>  
                                    </ul>
                                </div>
                            </div>
